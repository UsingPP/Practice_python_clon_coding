...
pygame.display.set_caption("공피하기 게임")
...
while running:
    ...
    character_x_pos += character_go_to
    ...
    weapons = [ [w[0], w[1]] for w in weapons if w[1] > -1] 
